(function () {
  ...
  // Google Ads Conversion: Label aus Google Ads eintragen (siehe GOOGLE-ADS-CONVERSION.txt)
  // Format: 'AW-328006841/AbCdEfGhIjK'  ← Teil nach dem Schrägstrich ist das Conversion-Label
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      var formData = {
        vorname: contactForm.elements.vorname.value.trim(),
        nachname: contactForm.elements.nachname.value.trim(),
        email: contactForm.elements.email.value.trim(),
        telefon: contactForm.elements.telefon.value.trim(),
        jahresverbrauch: contactForm.elements.jahresverbrauch.value.trim(),
        wohnsituation: contactForm.elements.wohnsituation.value,
        montageort: contactForm.elements.montageort.value,
        finanzierung_interesse: contactForm.elements.finanzierung_interesse.value,
        nachricht: contactForm.elements.nachricht.value.trim(),
      };
